<%@ Page Title="" Language="C#" MasterPageFile="~/CMS.Master" AutoEventWireup="true" CodeBehind="UserDetailsReport.aspx.cs" Inherits="WebApplication2.REPORTS.UserDetailsReport" %>
    ...
    <table  align="center" class="centered-table">
         <tr>
           ...
           <tr>
            ...
            <td>
                <asp:TextBox ID="txtUser_Id" runat="server" OnTextChanged="txtUser_Id_TextChanged" AutoPostBack ="true" ></asp:TextBox>
            </td>
        ...
        <tr>
             <td  colspan="2" align="center">
                  <asp:GridView ID="GvUsersReport" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" >
