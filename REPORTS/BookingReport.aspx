<%@ Page Title="" Language="C#" MasterPageFile="~/CMS.Master" AutoEventWireup="true" CodeBehind="BookingReport.aspx.cs" Inherits="WebApplication2.REPORTS.BookingReport" %>
...
<link href="../Css/Mainmaster.css" rel="stylesheet" />
    ...
    <table align="center" class="centered-table">
        <tr>
            <td>
                <asp:Label ID="lblHeading" runat="server" Text="Booking Report" CssClass="label-primary" Font-Size="Larger" Font-Italic="false"></asp:Label>
            </td>
        ...
        <tr>
         ...
         <tr>
             <td  colspan="2" align="center">
                  <asp:GridView ID="GvBookingsReport" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" >
